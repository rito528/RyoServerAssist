...
ALTER TABLE `Quests` CHANGE `id` `id` INT(11) NOT NULL;
ALTER TABLE Quests DROP PRIMARY KEY, ADD PRIMARY KEY (UUID(128));
...
CREATE TABLE IF NOT EXISTS ServerMaintenance(isMaintenance BOOLEAN);